...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Banlayacağın Kişiyi Etiketliyip Sonra Ban Sebebini Yazmalısın. örnek: k!ban @user sebep');
  ...
  .setColor("RANDOM")
  .setDescription(`${user.username}#${user.discriminator} Banlanmıştır`)
