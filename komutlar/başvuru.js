...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Ne Kazandirirsiniz,Istediniz Yetki,Kac Saat Aktif Olacaginiz,Adiniz,Yasiniz ve Kendinizi Etiketleyin.                                                                                                                 Örnek: k!başvuru Sunucuya Adam Getiririm, Destek Ekibi, Günde 5 saat aktif olurum, Emircan, 17 @Kullanıcı Adın ');
